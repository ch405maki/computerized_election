...
<template>
    <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
        ...
        <div class="relative w-full sm:w-64">
            ...
            <Input placeholder="Search voters..." class="pl-9" v-model="searchQuery" @input="handleSearch" />
        </div>

        <!-- Activate All Button -->
        <Button variant="default" v-if="hasInactiveVoters" @click="$emit('activateAll')" :disabled="isActivatingAll">

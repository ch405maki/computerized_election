        ...
        <Table>
            ...
            <TableBody>
                <TableRow v-if="inactiveVoters.length === 0">
                    <TableCell colspan="6" class="py-8 text-center text-muted-foreground"> No pending voter activations </TableCell>
                </TableRow>
                <TableRow v-for="voter in inactiveVoters" :key="voter.id">
                    ...
                    <TableCell class="text-right">
                        <Button @click="emit('activate', voter.id)" :disabled="isLoading" size="sm">

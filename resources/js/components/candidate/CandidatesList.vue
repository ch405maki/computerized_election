            ...
            <Table>
                ...
                <TableBody>
                    <TableRow v-if="candidates.length === 0">
                        <TableCell :colspan="canDeleteCandidate ? 7 : 6" class="text-center"> No candidates found </TableCell>
                    </TableRow>

                    <TableRow v-for="candidate in sortedCandidates" :key="candidate.id">
                        <TableCell class="h-10 w-10">
                            <img
                        ...
                        <TableCell v-if="canDeleteCandidate">
                            <div class="text-right">
                                <Button size="sm" variant="destructive" @click="openDeleteDialog(candidate)" :disabled="isDeleting">
                                    <Trash class="h-4 w-4 hover:text-red-700" />
                                </Button>
                            </div>
                        </TableCell>
                    </TableRow>
                ...
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        <div class="space-y-4 pt-2">
                            <p class="font-medium text-foreground">Confirm your password to delete the candidate.</p>
                            <Input type="password" v-model="deletePassword" placeholder="Enter admin password" @keyup.enter="deleteCandidate" />
                        </div>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>

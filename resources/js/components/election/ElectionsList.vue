                ...
                <TableBody>
                    ...
                    <TableRow v-for="election in elections" :key="election.id">
                        ...
                        <TableCell v-if="canEdit || canDelete" class="text-right">
                            <Button v-if="canEdit" variant="outline" size="sm" class="mr-2" @click="initiateEdit(election)">
                                <FilePenLine />
                            </Button>
                            <Button v-if="canDelete" variant="destructive" size="sm" @click="openDeleteDialog(election.id)">
                                <Trash />
                            </Button>
                        </TableCell>
                    </TableRow>
        ...
        <AlertDialog v-model:open="isPasswordDialogOpen">
            ...
            <AlertDialogContent>
                ...
                <AlertDialogFooter>
                    ...
                    <AlertDialogAction @click.prevent="verifyPasswordAndOpenEdit" :disabled="!adminPassword || isVerifying">
                ...
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription class="space-y-4">
                        ...
                        <div class="mt-2 border-t border-border pt-4">
                            ...
                            <Input type="password" v-model="deletePassword" placeholder="Enter your password" @keyup.enter="deleteElection" />
                        </div>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>

<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <TitleHeader title="Users Management" description="Manage all users and their permissions." />
            <!-- Search and Buttons -->
            <div class="flex items-center justify-between gap-4">
                <!-- Search Input -->
                <div class="relative w-full max-w-xs">
                    <Search class="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 transform text-muted-foreground" />
                    <Input v-model="searchQuery" type="text" placeholder="Search users..." class="h-9 w-full pl-9" />
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <Button @click="triggerFileInput" :disabled="loading" variant="outline">

...
const onSubmit = async () => {
    ...
    try {
        const response = await axios.post('/api/voters', formData.value);
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto py-8">
            <div class="max-w-2xl mx-auto bg-card rounded-lg shadow-sm border p-6">
                <h1 class="text-2xl font-bold mb-6">Register New Voter</h1>
